...
router.post(
  ...
  chatAppControllers.createGroup
);
router.delete(
  "/delete-group",
  userAuth.Authenticate,
  chatAppControllers.deleteGroup
);
router.get(
  "/get-messeges",
  userAuth.Authenticate,
  chatAppControllers.getMesseges
);
router.post(
  "/group/add-user",
  userAuth.Authenticate,
  chatAppControllers.addUser
);

router.get(
  "/get-contacts",
  userAuth.Authenticate,
  chatAppControllers.getContacts
);
router.get("/get-users", userAuth.Authenticate, chatAppControllers.getUsers);
router.delete(
  "/remove-user",
  userAuth.Authenticate,
  chatAppControllers.removeUser
);
